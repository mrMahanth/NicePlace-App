// Converted from indiaStatesDistricts.js — used for State/District dropdown
// selection + validation in the Basic Details screen.
const Map<String, List<String>> indiaStatesDistricts = {
  ...
  "Nagaland": [
    ...
    "Mokokchung", "Mon", "Noklak", "Peren", "Phek", "Tseminyu",
  ...
  "Punjab": [
    ...
    "Pathankot", "Patiala", "Rupnagar", "Sangrur",
...
final List<String> indiaStatesList = indiaStatesDistricts.keys.toList();